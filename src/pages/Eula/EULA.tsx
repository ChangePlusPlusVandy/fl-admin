  ...
  return (
    <div>
      <h2>
        ...
        <span className="app_name">Friends++</span>
      </h2>
      <p>
        This End-User License Agreement ("EULA") is a legal agreement between
        you and <span className="company_name">Friends Life Community</span>.
        Our EULA was created by{" "}
        <a href="https://www.eulatemplate.com">EULA Template</a> for{" "}
        <span className="app_name">Friends++</span>.
      </p>
      <p>
        This EULA agreement governs your acquisition and use of our{" "}
        <span className="app_name">Friends++</span> software ("Software")
        directly from{" "}
        <span className="company_name">Friends Life Community</span> or
        indirectly through a{" "}
        <span className="company_name">Friends Life Community</span> authorized
      ...
      <p>
        ...
        <span className="app_name">Friends++</span> software. It provides a
        license to use the <span className="app_name">Friends++</span> software
        and contains warranty information and liability disclaimers.
      </p>
      <p>
        If you register for a free trial of the{" "}
        <span className="app_name">Friends++</span> software, this EULA
        agreement will also govern that trial. By clicking "accept" or
        installing and/or using the <span className="app_name">Friends++</span>{" "}
      ...
      <p>
        ...
        <span className="company_name">Friends Life Community</span> herewith
        regardless of whether other software is referred to or described herein.
        The terms also apply to any{" "}
        <span className="company_name">Friends Life Community</span> updates,
      ...
      <h3>License Grant</h3>
      <p>
        <span className="company_name">Friends Life Community</span> hereby
        grants you a personal, non-transferable, non-exclusive licence to use
        the <span className="app_name">Friends++</span> software on your devices
        in accordance with the terms of this EULA agreement.
      </p>
      <p>
        You are permitted to load the{" "}
        <span className="app_name">Friends++</span> software (for example a PC,
      ...
      <ul>
        ...
        <li>
          ...
          <span className="company_name">Friends Life Community</span> considers
          is a breach of this EULA agreement
        </li>
      </ul>
      <h3>Intellectual Property and Ownership</h3>
      <p>
        <span className="company_name">Friends Life Community</span> shall at
        all times retain ownership of the Software as originally downloaded by
        you and all subsequent downloads of the Software by you. The Software
        (and the copyright, and other intellectual property rights of whatever
        nature in the Software, including any modifications made thereto) are
        and shall remain the property of{" "}
        <span className="company_name">Friends Life Community</span>.
      </p>
      <p>
        <span className="company_name">Friends Life Community</span> reserves
